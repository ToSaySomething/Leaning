...
bool CustomTCPConnection::onlyread()// read
{
...
bool CustomTCPConnection::readheardbeat()
{
...
bool CustomTCPConnection::isflagformat(std::string buffer, const int len)
{
    if(len >= MIN_RECV_LEN)
    {
...
void CustomTCPConnection::display_message(std::string rece_string)
{
...
std::string CustomTCPConnection::tra_message(std::string data1)
{
    people::People p;
    p.set_head("head");
    p.set_name("Hideto");
